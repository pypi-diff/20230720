# Comparing `tmp/CodeToCAD-0.2.1689879910.tar.gz` & `tmp/CodeToCAD-0.2.6.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "CodeToCAD-0.2.1689879910.tar", last modified: Thu Jul 20 19:05:54 2023, max compression
+gzip compressed data, was "CodeToCAD-0.2.6.tar", last modified: Tue Mar 14 18:44:06 2023, max compression
```

## Comparing `CodeToCAD-0.2.1689879910.tar` & `CodeToCAD-0.2.6.tar`

### file list

```diff
@@ -1,19 +1,17 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-20 19:05:54.399421 CodeToCAD-0.2.1689879910/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-20 19:05:54.399421 CodeToCAD-0.2.1689879910/CodeToCAD/
--rw-r--r--   0 runner    (1001) docker     (123)    59241 2023-07-20 19:05:47.000000 CodeToCAD-0.2.1689879910/CodeToCAD/CodeToCADInterface.py
--rw-r--r--   0 runner    (1001) docker     (123)    25118 2023-07-20 19:05:47.000000 CodeToCAD-0.2.1689879910/CodeToCAD/CodeToCADProvider.py
--rw-r--r--   0 runner    (1001) docker     (123)    35376 2023-07-20 19:05:47.000000 CodeToCAD-0.2.1689879910/CodeToCAD/TestCodeToCADProvider.py
--rw-r--r--   0 runner    (1001) docker     (123)     3539 2023-07-20 19:05:47.000000 CodeToCAD-0.2.1689879910/CodeToCAD/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)    33138 2023-07-20 19:05:47.000000 CodeToCAD-0.2.1689879910/CodeToCAD/utilities.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-20 19:05:54.399421 CodeToCAD-0.2.1689879910/CodeToCAD.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     7489 2023-07-20 19:05:54.000000 CodeToCAD-0.2.1689879910/CodeToCAD.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      325 2023-07-20 19:05:54.000000 CodeToCAD-0.2.1689879910/CodeToCAD.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-07-20 19:05:54.000000 CodeToCAD-0.2.1689879910/CodeToCAD.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       10 2023-07-20 19:05:54.000000 CodeToCAD-0.2.1689879910/CodeToCAD.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)    32473 2023-07-20 19:05:47.000000 CodeToCAD-0.2.1689879910/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)       19 2023-07-20 19:05:47.000000 CodeToCAD-0.2.1689879910/MANIFEST.in
--rw-r--r--   0 runner    (1001) docker     (123)     7489 2023-07-20 19:05:54.399421 CodeToCAD-0.2.1689879910/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     6947 2023-07-20 19:05:47.000000 CodeToCAD-0.2.1689879910/README.md
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-07-20 19:05:54.399421 CodeToCAD-0.2.1689879910/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     1079 2023-07-20 19:05:47.000000 CodeToCAD-0.2.1689879910/setup.py
--rw-r--r--   0 runner    (1001) docker     (123)       10 2023-07-20 19:05:54.000000 CodeToCAD-0.2.1689879910/version.txt
...
### Comparing `CodeToCAD-0.2.1689879910/CodeToCAD/CodeToCADInterface.py` & `CodeToCAD-0.2.6/CodeToCAD/CodeToCADInterface.py`
...
### Comparing `CodeToCAD-0.2.1689879910/CodeToCAD/TestCodeToCADProvider.py` & `CodeToCAD-0.2.6/CodeToCAD/TestCodeToCADProvider.py`
...
### Comparing `CodeToCAD-0.2.1689879910/CodeToCAD/__init__.py` & `CodeToCAD-0.2.6/CodeToCAD/__init__.py`
...
### Comparing `CodeToCAD-0.2.1689879910/CodeToCAD/utilities.py` & `CodeToCAD-0.2.6/CodeToCAD/utilities.py`
...
### Comparing `CodeToCAD-0.2.1689879910/CodeToCAD.egg-info/PKG-INFO` & `CodeToCAD-0.2.6/CodeToCAD.egg-info/PKG-INFO`
...
### Comparing `CodeToCAD-0.2.1689879910/LICENSE` & `CodeToCAD-0.2.6/LICENSE`

 * *Files identical despite different names*

### Comparing `CodeToCAD-0.2.1689879910/PKG-INFO` & `CodeToCAD-0.2.6/PKG-INFO`
