# Comparing `tmp/nasops-0.0.2.tar.gz` & `tmp/nasops-0.0.3.tar.gz`
...
+gzip compressed data, was "nasops-0.0.3.tar", last modified: Thu Jul 20 07:54:58 2023, max compression
```

## Comparing `nasops-0.0.2.tar` & `nasops-0.0.3.tar`
...
+drwxrwxr-x   0 user      (1000) user      (1000)        0 2023-07-20 07:54:58.506275 nasops-0.0.3/
+-rw-rw-r--   0 user      (1000) user      (1000)      169 2023-07-20 07:54:58.506275 nasops-0.0.3/PKG-INFO
+-rw-rw-r--   0 user      (1000) user      (1000)      434 2023-07-20 07:48:38.000000 nasops-0.0.3/README.md
+drwxrwxr-x   0 user      (1000) user      (1000)        0 2023-07-20 07:54:58.506275 nasops-0.0.3/dtools/
+-rw-rw-r--   0 user      (1000) user      (1000)        0 2022-05-18 10:40:46.000000 nasops-0.0.3/dtools/__init__.py
+-rw-rw-r--   0 user      (1000) user      (1000)     2679 2023-07-20 07:35:31.000000 nasops-0.0.3/dtools/__main__.py
+-rw-rw-r--   0 user      (1000) user      (1000)     2961 2023-07-20 07:50:34.000000 nasops-0.0.3/dtools/main.py
+-rw-rw-r--   0 user      (1000) user      (1000)     9013 2023-07-20 07:51:24.000000 nasops-0.0.3/dtools/util.py
+drwxrwxr-x   0 user      (1000) user      (1000)        0 2023-07-20 07:54:58.506275 nasops-0.0.3/nasops.egg-info/
+-rw-rw-r--   0 user      (1000) user      (1000)      169 2023-07-20 07:54:58.000000 nasops-0.0.3/nasops.egg-info/PKG-INFO
+-rw-rw-r--   0 user      (1000) user      (1000)      278 2023-07-20 07:54:58.000000 nasops-0.0.3/nasops.egg-info/SOURCES.txt
+-rw-rw-r--   0 user      (1000) user      (1000)        1 2023-07-20 07:54:58.000000 nasops-0.0.3/nasops.egg-info/dependency_links.txt
+-rw-rw-r--   0 user      (1000) user      (1000)       44 2023-07-20 07:54:58.000000 nasops-0.0.3/nasops.egg-info/entry_points.txt
+-rw-rw-r--   0 user      (1000) user      (1000)       27 2023-07-20 07:54:58.000000 nasops-0.0.3/nasops.egg-info/requires.txt
+-rw-rw-r--   0 user      (1000) user      (1000)        7 2023-07-20 07:54:58.000000 nasops-0.0.3/nasops.egg-info/top_level.txt
+-rw-rw-r--   0 user      (1000) user      (1000)       38 2023-07-20 07:54:58.506275 nasops-0.0.3/setup.cfg
+-rw-rw-r--   0 user      (1000) user      (1000)      506 2023-07-20 07:44:17.000000 nasops-0.0.3/setup.py
```

### Comparing `nasops-0.0.2/dtools/main.py` & `nasops-0.0.3/dtools/main.py`
...
### Comparing `nasops-0.0.2/dtools/util.py` & `nasops-0.0.3/dtools/util.py`
