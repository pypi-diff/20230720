# Comparing `tmp/responsecurve-0.0.4.tar.gz` & `tmp/responsecurve-0.0.5.tar.gz`
...
## Comparing `responsecurve-0.0.4.tar` & `responsecurve-0.0.5.tar`
...
### Comparing `responsecurve-0.0.4/LICENSE` & `responsecurve-0.0.5/LICENSE`

 * *Files identical despite different names*

### Comparing `responsecurve-0.0.4/setup.py` & `responsecurve-0.0.5/setup.py`
