# Comparing `tmp/code_loader-0.2.84.dev1.tar.gz` & `tmp/code-loader-0.2.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "code_loader-0.2.84.dev1.tar", max compression
+gzip compressed data, was "code-loader-0.2.9.tar", max compression
```

## Comparing `code_loader-0.2.84.dev1.tar` & `code-loader-0.2.9.tar`

### file list

```diff
@@ -1,34 +1,17 @@
--rw-r--r--   0        0        0     1067 2021-12-01 12:49:40.221608 code_loader-0.2.84.dev1/LICENSE
--rw-r--r--   0        0        0       63 2021-12-01 12:49:40.221888 code_loader-0.2.84.dev1/README.md
--rw-r--r--   0        0        0      116 2022-05-11 11:47:06.009274 code_loader-0.2.84.dev1/code_loader/__init__.py
--rw-r--r--   0        0        0        0 2021-12-01 12:49:40.222215 code_loader-0.2.84.dev1/code_loader/contract/__init__.py
--rw-r--r--   0        0        0     4268 2023-07-20 08:48:50.289546 code_loader-0.2.84.dev1/code_loader/contract/datasetclasses.py
--rw-r--r--   0        0        0     1481 2023-02-20 09:25:15.315334 code_loader-0.2.84.dev1/code_loader/contract/enums.py
--rw-r--r--   0        0        0       51 2023-01-25 08:28:09.946315 code_loader-0.2.84.dev1/code_loader/contract/exceptions.py
--rw-r--r--   0        0        0     2577 2023-04-30 15:22:08.939547 code_loader-0.2.84.dev1/code_loader/contract/responsedataclasses.py
--rw-r--r--   0        0        0     4761 2022-09-14 12:54:18.363656 code_loader-0.2.84.dev1/code_loader/contract/visualizer_classes.py
--rw-r--r--   0        0        0        0 2023-02-20 09:25:15.316077 code_loader-0.2.84.dev1/code_loader/helpers/__init__.py
--rw-r--r--   0        0        0        0 2023-02-20 09:25:15.316230 code_loader-0.2.84.dev1/code_loader/helpers/detection/__init__.py
--rw-r--r--   0        0        0     7527 2023-02-20 09:25:15.316380 code_loader-0.2.84.dev1/code_loader/helpers/detection/utils.py
--rw-r--r--   0        0        0        0 2023-02-20 09:25:15.316494 code_loader-0.2.84.dev1/code_loader/helpers/detection/yolo/__init__.py
--rw-r--r--   0        0        0     7905 2023-07-16 08:27:34.163957 code_loader-0.2.84.dev1/code_loader/helpers/detection/yolo/decoder.py
--rw-r--r--   0        0        0       81 2023-07-16 08:27:34.164260 code_loader-0.2.84.dev1/code_loader/helpers/detection/yolo/enums.py
--rw-r--r--   0        0        0     3132 2023-02-20 09:25:15.316760 code_loader-0.2.84.dev1/code_loader/helpers/detection/yolo/grid.py
--rw-r--r--   0        0        0    18643 2023-06-13 11:54:04.301674 code_loader-0.2.84.dev1/code_loader/helpers/detection/yolo/loss.py
--rw-r--r--   0        0        0    11349 2023-06-13 11:54:04.302521 code_loader-0.2.84.dev1/code_loader/helpers/detection/yolo/pytorch_utils.py
--rw-r--r--   0        0        0     8037 2023-07-16 08:27:34.165465 code_loader-0.2.84.dev1/code_loader/helpers/detection/yolo/utils.py
--rw-r--r--   0        0        0        0 2023-06-11 16:22:23.627990 code_loader-0.2.84.dev1/code_loader/helpers/instancesegmentation/__init__.py
--rw-r--r--   0        0        0      930 2023-06-11 16:22:23.628351 code_loader-0.2.84.dev1/code_loader/helpers/instancesegmentation/utils.py
--rw-r--r--   0        0        0       93 2022-05-11 11:47:06.012412 code_loader-0.2.84.dev1/code_loader/leap_binder/__init__.py
--rw-r--r--   0        0        0     6692 2023-06-13 09:26:35.922152 code_loader-0.2.84.dev1/code_loader/leap_binder/leapbinder.py
--rw-r--r--   0        0        0     4507 2023-07-20 08:40:22.622634 code_loader-0.2.84.dev1/code_loader/leap_loader_parallelized_base.py
--rw-r--r--   0        0        0    15370 2023-07-16 08:27:34.165898 code_loader-0.2.84.dev1/code_loader/leaploader.py
--rw-r--r--   0        0        0     2075 2023-07-20 09:00:23.919140 code_loader-0.2.84.dev1/code_loader/metric_calculator_parallelized.py
--rw-r--r--   0        0        0        0 2023-02-20 09:25:15.317766 code_loader-0.2.84.dev1/code_loader/metrics/__init__.py
--rw-r--r--   0        0        0     6727 2023-03-09 14:01:48.440482 code_loader-0.2.84.dev1/code_loader/metrics/default_metrics.py
--rw-r--r--   0        0        0     2335 2023-07-20 08:59:47.828432 code_loader-0.2.84.dev1/code_loader/samples_generator_parallelized.py
--rw-r--r--   0        0        0     1736 2022-05-11 11:47:06.013107 code_loader-0.2.84.dev1/code_loader/utils.py
--rw-r--r--   0        0        0        0 2022-05-19 06:59:13.641605 code_loader-0.2.84.dev1/code_loader/visualizers/__init__.py
--rw-r--r--   0        0        0     2226 2023-06-15 14:22:18.899732 code_loader-0.2.84.dev1/code_loader/visualizers/default_visualizers.py
--rw-r--r--   0        0        0      905 2023-07-20 09:21:17.247089 code_loader-0.2.84.dev1/pyproject.toml
--rw-r--r--   0        0        0      952 1970-01-01 00:00:00.000000 code_loader-0.2.84.dev1/PKG-INFO
...
### Comparing `code_loader-0.2.84.dev1/LICENSE` & `code-loader-0.2.9/LICENSE`

 * *Files identical despite different names*

### Comparing `code_loader-0.2.84.dev1/code_loader/contract/enums.py` & `code-loader-0.2.9/code_loader/contract/enums.py`
...
### Comparing `code_loader-0.2.84.dev1/code_loader/contract/responsedataclasses.py` & `code-loader-0.2.9/code_loader/contract/responsedataclasses.py`
...
### Comparing `code_loader-0.2.84.dev1/code_loader/utils.py` & `code-loader-0.2.9/code_loader/utils.py`
...
### Comparing `code_loader-0.2.84.dev1/pyproject.toml` & `code-loader-0.2.9/pyproject.toml`
