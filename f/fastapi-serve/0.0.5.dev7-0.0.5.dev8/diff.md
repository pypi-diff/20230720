# Comparing `tmp/fastapi-serve-0.0.5.dev7.tar.gz` & `tmp/fastapi-serve-0.0.5.dev8.tar.gz`
...
+gzip compressed data, was "fastapi-serve-0.0.5.dev8.tar", last modified: Thu Jul 20 08:25:03 2023, max compression
```

## Comparing `fastapi-serve-0.0.5.dev7.tar` & `fastapi-serve-0.0.5.dev8.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-20 08:25:03.132787 fastapi-serve-0.0.5.dev8/
+-rw-r--r--   0 runner    (1001) docker     (123)    11357 2023-07-20 08:24:58.000000 fastapi-serve-0.0.5.dev8/LICENSE
+-rw-r--r--   0 runner    (1001) docker     (123)      172 2023-07-20 08:24:58.000000 fastapi-serve-0.0.5.dev8/MANIFEST.in
+-rw-r--r--   0 runner    (1001) docker     (123)     6404 2023-07-20 08:25:03.132787 fastapi-serve-0.0.5.dev8/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)     5147 2023-07-20 08:24:58.000000 fastapi-serve-0.0.5.dev8/README.md
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-20 08:25:03.128787 fastapi-serve-0.0.5.dev8/fastapi_serve/
+-rw-r--r--   0 runner    (1001) docker     (123)      436 2023-07-20 08:25:02.000000 fastapi-serve-0.0.5.dev8/fastapi_serve/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)     3190 2023-07-20 08:24:58.000000 fastapi-serve-0.0.5.dev8/fastapi_serve/__main__.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-20 08:25:03.132787 fastapi-serve-0.0.5.dev8/fastapi_serve/cloud/
+-rw-r--r--   0 runner    (1001) docker     (123)      378 2023-07-20 08:24:58.000000 fastapi-serve-0.0.5.dev8/fastapi_serve/cloud/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)     8787 2023-07-20 08:24:58.000000 fastapi-serve-0.0.5.dev8/fastapi_serve/cloud/build.py
+-rw-r--r--   0 runner    (1001) docker     (123)     7902 2023-07-20 08:24:58.000000 fastapi-serve-0.0.5.dev8/fastapi_serve/cloud/config.py
+-rw-r--r--   0 runner    (1001) docker     (123)    12450 2023-07-20 08:24:58.000000 fastapi-serve-0.0.5.dev8/fastapi_serve/cloud/deploy.py
+-rw-r--r--   0 runner    (1001) docker     (123)      681 2023-07-20 08:24:58.000000 fastapi-serve-0.0.5.dev8/fastapi_serve/cloud/errors.py
+-rw-r--r--   0 runner    (1001) docker     (123)     2011 2023-07-20 08:24:58.000000 fastapi-serve-0.0.5.dev8/fastapi_serve/cloud/export.py
+-rw-r--r--   0 runner    (1001) docker     (123)      934 2023-07-20 08:24:58.000000 fastapi-serve-0.0.5.dev8/fastapi_serve/cloud/helper.py
+-rw-r--r--   0 runner    (1001) docker     (123)     5346 2023-07-20 08:24:58.000000 fastapi-serve-0.0.5.dev8/fastapi_serve/cloud/options.py
+-rw-r--r--   0 runner    (1001) docker     (123)       97 2023-07-20 08:24:58.000000 fastapi-serve-0.0.5.dev8/fastapi_serve/config.yml
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-20 08:25:03.132787 fastapi-serve-0.0.5.dev8/fastapi_serve/gateway/
+-rw-r--r--   0 runner    (1001) docker     (123)       41 2023-07-20 08:24:58.000000 fastapi-serve-0.0.5.dev8/fastapi_serve/gateway/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)     4642 2023-07-20 08:24:58.000000 fastapi-serve-0.0.5.dev8/fastapi_serve/gateway/gateway.py
+-rw-r--r--   0 runner    (1001) docker     (123)     6509 2023-07-20 08:24:58.000000 fastapi-serve-0.0.5.dev8/fastapi_serve/gateway/helper.py
+-rw-r--r--   0 runner    (1001) docker     (123)     2085 2023-07-20 08:24:58.000000 fastapi-serve-0.0.5.dev8/fastapi_serve/helper.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-20 08:25:03.132787 fastapi-serve-0.0.5.dev8/fastapi_serve/utils/
+-rw-r--r--   0 runner    (1001) docker     (123)      109 2023-07-20 08:24:58.000000 fastapi-serve-0.0.5.dev8/fastapi_serve/utils/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)     2599 2023-07-20 08:24:58.000000 fastapi-serve-0.0.5.dev8/fastapi_serve/utils/auth.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-20 08:25:03.132787 fastapi-serve-0.0.5.dev8/fastapi_serve/utils/blob/
+-rw-r--r--   0 runner    (1001) docker     (123)       37 2023-07-20 08:24:58.000000 fastapi-serve-0.0.5.dev8/fastapi_serve/utils/blob/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)     2342 2023-07-20 08:24:58.000000 fastapi-serve-0.0.5.dev8/fastapi_serve/utils/blob/storage.py
+-rw-r--r--   0 runner    (1001) docker     (123)     1018 2023-07-20 08:24:58.000000 fastapi-serve-0.0.5.dev8/fastapi_serve/utils/helper.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-20 08:25:03.128787 fastapi-serve-0.0.5.dev8/fastapi_serve.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (123)     6404 2023-07-20 08:25:03.000000 fastapi-serve-0.0.5.dev8/fastapi_serve.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)      920 2023-07-20 08:25:03.000000 fastapi-serve-0.0.5.dev8/fastapi_serve.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2023-07-20 08:25:03.000000 fastapi-serve-0.0.5.dev8/fastapi_serve.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       64 2023-07-20 08:25:03.000000 fastapi-serve-0.0.5.dev8/fastapi_serve.egg-info/entry_points.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2023-07-20 08:25:03.000000 fastapi-serve-0.0.5.dev8/fastapi_serve.egg-info/not-zip-safe
+-rw-r--r--   0 runner    (1001) docker     (123)       74 2023-07-20 08:25:03.000000 fastapi-serve-0.0.5.dev8/fastapi_serve.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       20 2023-07-20 08:25:03.000000 fastapi-serve-0.0.5.dev8/fastapi_serve.egg-info/top_level.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       36 2023-07-20 08:24:58.000000 fastapi-serve-0.0.5.dev8/requirements.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       38 2023-07-20 08:25:03.132787 fastapi-serve-0.0.5.dev8/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (123)     2937 2023-07-20 08:24:58.000000 fastapi-serve-0.0.5.dev8/setup.py
```

### Comparing `fastapi-serve-0.0.5.dev7/LICENSE` & `fastapi-serve-0.0.5.dev8/LICENSE`

 * *Files identical despite different names*

### Comparing `fastapi-serve-0.0.5.dev7/PKG-INFO` & `fastapi-serve-0.0.5.dev8/PKG-INFO`
...
+Metadata-Version: 2.1 Name: fastapi-serve Version: 0.0.5.dev8 Summary: FastAPI
...
+handling of secrets and environment variables. - ðï¸ **Hardware**: Tailor
+your deployment to suit specific needs. - ð **Authorization**: Built-in
+OAuth2.0 token-based security to secure your endpoints. - ð¾ **App Storage**:
+Persistent and secure network storage for your app data. - ð **Blob
+Storage**: Built-in support for seamless user file uploads and downloads. -
+ð **Observability**: Integrated access to logs, metrics, and traces.
+(Alerting coming soon!) - ð¦ **Containerization**: Effortless
+containerization of your Python codebase with our integrated registry. -
+ð ï¸ **Self-Hosting**: Export your app for self-hosting with ease, including
+docker-compose and Kubernetes yamls. ## ð¡ Getting Started First, install the
+`fastapi-serve` package using pip: ```bash pip install fastapi-serve ``` Then,
+simply use the `fastapi-serve` command to deploy your FastAPI application:
+```bash fastapi-serve deploy jcloud main:app ``` You'll get a URL to access
+your newly deployed application along with the Swagger UI. ## ð
+Documentation Dive into understanding `fastapi-serve` through our comprehensive
+documentation and examples: - ð **Getting Started** - ð§± [Deploy a Simple
+FastAPI Application](docs/simple/) - ð¥ï¸ [Dig deep into the `fastapi-serve`
+CLI](docs/CLI.md) - âï¸ [Understanding Configuration and Pricing](docs/
+CONFIG.MD) - ð¢ Managing Larger Applications with Complex Directory Structure
+(Example TBD!) - âï¸ **Scaling** - ð¹ [Auto-scaling endpoints based on CPU
+usage](docs/autoscaling/cpu/) - ð [Serverless (scale-to-zero) deployments
+based on RPS](docs/autoscaling/serverless/) - ð§© **Config & Credentials** -
+ð [Leverage Environment Variables for app configuration](docs/envs/) -
+ðï¸ [Use Secrets for Redis-Powered Rate Limiting](docs/rate_limit/) - ð¾
+**Storage** - ð [Handle File Uploads and Downloads with built-in Blob
...
+Dockerfile (Coming Soon!) - â¸ï¸ [Export Your App for Self-Hosting with
+docker-compose / Kubernetes](docs/export/) - ð **Observability** - ð
+Access Logs, Metrics, and Traces for your app (Example TBD!) - ð¨ Set up
+Alerts for your app (Coming Soon!) ## ðª Support If you encounter any
...
### Comparing `fastapi-serve-0.0.5.dev7/README.md` & `fastapi-serve-0.0.5.dev8/README.md`
...
### Comparing `fastapi-serve-0.0.5.dev7/fastapi_serve/__main__.py` & `fastapi-serve-0.0.5.dev8/fastapi_serve/__main__.py`

 * *Files identical despite different names*

### Comparing `fastapi-serve-0.0.5.dev7/fastapi_serve/cloud/build.py` & `fastapi-serve-0.0.5.dev8/fastapi_serve/cloud/build.py`

 * *Files identical despite different names*

### Comparing `fastapi-serve-0.0.5.dev7/fastapi_serve/cloud/config.py` & `fastapi-serve-0.0.5.dev8/fastapi_serve/cloud/config.py`

 * *Files identical despite different names*

### Comparing `fastapi-serve-0.0.5.dev7/fastapi_serve/cloud/deploy.py` & `fastapi-serve-0.0.5.dev8/fastapi_serve/cloud/deploy.py`

 * *Files identical despite different names*

### Comparing `fastapi-serve-0.0.5.dev7/fastapi_serve/cloud/errors.py` & `fastapi-serve-0.0.5.dev8/fastapi_serve/cloud/errors.py`

 * *Files identical despite different names*

### Comparing `fastapi-serve-0.0.5.dev7/fastapi_serve/cloud/export.py` & `fastapi-serve-0.0.5.dev8/fastapi_serve/cloud/export.py`

 * *Files identical despite different names*

### Comparing `fastapi-serve-0.0.5.dev7/fastapi_serve/cloud/helper.py` & `fastapi-serve-0.0.5.dev8/fastapi_serve/cloud/helper.py`

 * *Files identical despite different names*

### Comparing `fastapi-serve-0.0.5.dev7/fastapi_serve/cloud/options.py` & `fastapi-serve-0.0.5.dev8/fastapi_serve/cloud/options.py`

 * *Files identical despite different names*

### Comparing `fastapi-serve-0.0.5.dev7/fastapi_serve/gateway/gateway.py` & `fastapi-serve-0.0.5.dev8/fastapi_serve/gateway/gateway.py`

 * *Files identical despite different names*

### Comparing `fastapi-serve-0.0.5.dev7/fastapi_serve/gateway/helper.py` & `fastapi-serve-0.0.5.dev8/fastapi_serve/gateway/helper.py`

 * *Files identical despite different names*

### Comparing `fastapi-serve-0.0.5.dev7/fastapi_serve/helper.py` & `fastapi-serve-0.0.5.dev8/fastapi_serve/helper.py`

 * *Files identical despite different names*

### Comparing `fastapi-serve-0.0.5.dev7/fastapi_serve/utils/auth.py` & `fastapi-serve-0.0.5.dev8/fastapi_serve/utils/auth.py`

 * *Files identical despite different names*

### Comparing `fastapi-serve-0.0.5.dev7/fastapi_serve/utils/blob/storage.py` & `fastapi-serve-0.0.5.dev8/fastapi_serve/utils/blob/storage.py`

 * *Files identical despite different names*

### Comparing `fastapi-serve-0.0.5.dev7/fastapi_serve/utils/helper.py` & `fastapi-serve-0.0.5.dev8/fastapi_serve/utils/helper.py`

 * *Files identical despite different names*

### Comparing `fastapi-serve-0.0.5.dev7/fastapi_serve.egg-info/PKG-INFO` & `fastapi-serve-0.0.5.dev8/fastapi_serve.egg-info/PKG-INFO`
...
### Comparing `fastapi-serve-0.0.5.dev7/fastapi_serve.egg-info/SOURCES.txt` & `fastapi-serve-0.0.5.dev8/fastapi_serve.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `fastapi-serve-0.0.5.dev7/setup.py` & `fastapi-serve-0.0.5.dev8/setup.py`
