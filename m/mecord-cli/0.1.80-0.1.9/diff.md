# Comparing `tmp/mecord-cli-0.1.80.tar.gz` & `tmp/mecord-cli-0.1.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "mecord-cli-0.1.80.tar", last modified: Thu Jul 20 09:00:02 2023, max compression
+gzip compressed data, was "mecord-cli-0.1.9.tar", last modified: Mon Mar 13 11:30:29 2023, max compression
```

## Comparing `mecord-cli-0.1.80.tar` & `mecord-cli-0.1.9.tar`

### file list

```diff
@@ -1,46 +1,42 @@
-drwxrwxrwx   0        0        0        0 2023-07-20 09:00:02.114978 mecord-cli-0.1.80/
--rw-rw-rw-   0        0        0     1078 2023-02-16 06:18:02.000000 mecord-cli-0.1.80/LICENSE
--rw-rw-rw-   0        0        0     2364 2023-07-20 09:00:02.113977 mecord-cli-0.1.80/PKG-INFO
--rw-rw-rw-   0        0        0     1942 2023-04-21 14:39:36.000000 mecord-cli-0.1.80/README.md
-drwxrwxrwx   0        0        0        0 2023-07-20 09:00:02.094976 mecord-cli-0.1.80/mecord/
--rw-rw-rw-   0        0        0        0 2023-02-27 08:17:36.000000 mecord-cli-0.1.80/mecord/__init__.py
--rw-rw-rw-   0        0        0    56500 2023-06-09 09:58:53.000000 mecord-cli-0.1.80/mecord/aigc_ext_pb2.py
--rw-rw-rw-   0        0        0     8397 2023-07-17 08:40:05.000000 mecord-cli-0.1.80/mecord/capability_provider.py
--rw-rw-rw-   0        0        0    40930 2023-06-09 09:58:18.000000 mecord-cli-0.1.80/mecord/common_ext_pb2.py
--rw-rw-rw-   0        0        0      173 2023-07-20 09:00:01.000000 mecord-cli-0.1.80/mecord/constant.py
--rw-rw-rw-   0        0        0     1934 2023-07-17 07:17:48.000000 mecord-cli-0.1.80/mecord/main.py
--rw-rw-rw-   0        0        0    10730 2023-07-20 07:42:05.000000 mecord-cli-0.1.80/mecord/mecord_service.py
--rw-rw-rw-   0        0        0    11578 2023-07-19 09:58:48.000000 mecord-cli-0.1.80/mecord/mecord_widget.py
--rw-rw-rw-   0        0        0    11142 2023-07-20 08:59:40.000000 mecord-cli-0.1.80/mecord/progress_monitor.py
-drwxrwxrwx   0        0        0        0 2023-07-20 09:00:02.096975 mecord-cli-0.1.80/mecord/public_tools/
--rw-rw-rw-   0        0        0        0 2023-04-21 14:39:36.000000 mecord-cli-0.1.80/mecord/public_tools/__init__.py
--rw-rw-rw-   0        0        0      302 2023-04-21 14:39:36.000000 mecord-cli-0.1.80/mecord/public_tools/decorator_tools.py
--rw-rw-rw-   0        0        0     3250 2023-06-09 09:58:18.000000 mecord-cli-0.1.80/mecord/rpcinput_pb2.py
-drwxrwxrwx   0        0        0        0 2023-07-20 09:00:02.100976 mecord-cli-0.1.80/mecord/script_template/
--rw-rw-rw-   0        0        0        0 2023-03-01 01:46:57.000000 mecord-cli-0.1.80/mecord/script_template/__init__.py
--rw-rw-rw-   0        0        0      312 2023-04-21 14:39:36.000000 mecord-cli-0.1.80/mecord/script_template/launch.py
--rw-rw-rw-   0        0        0      915 2023-04-10 11:57:12.000000 mecord-cli-0.1.80/mecord/script_template/main.py
--rw-rw-rw-   0        0        0      801 2023-03-15 02:24:04.000000 mecord-cli-0.1.80/mecord/script_template/run.py
--rw-rw-rw-   0        0        0     6002 2023-07-20 07:38:44.000000 mecord-cli-0.1.80/mecord/store.py
--rw-rw-rw-   0        0        0     8745 2023-06-09 09:58:18.000000 mecord-cli-0.1.80/mecord/uauth_common_pb2.py
--rw-rw-rw-   0        0        0   108609 2023-06-09 09:58:56.000000 mecord-cli-0.1.80/mecord/uauth_ext_pb2.py
--rw-rw-rw-   0        0        0     2375 2023-07-20 07:39:19.000000 mecord-cli-0.1.80/mecord/upload.py
--rw-rw-rw-   0        0        0    12849 2023-06-09 09:58:55.000000 mecord-cli-0.1.80/mecord/user_status_ext_pb2.py
--rw-rw-rw-   0        0        0    12538 2023-07-17 06:01:30.000000 mecord-cli-0.1.80/mecord/utils.py
-drwxrwxrwx   0        0        0        0 2023-07-20 09:00:02.107978 mecord-cli-0.1.80/mecord/widget_template/
--rw-rw-rw-   0        0        0     1977 2023-03-14 11:34:25.000000 mecord-cli-0.1.80/mecord/widget_template/MekongJS.js.py
--rw-rw-rw-   0        0        0        0 2023-03-01 01:46:57.000000 mecord-cli-0.1.80/mecord/widget_template/__init__.py
--rw-rw-rw-   0        0        0      219 2023-04-21 14:39:36.000000 mecord-cli-0.1.80/mecord/widget_template/config.json.py
--rw-rw-rw-   0        0        0     1678 2023-03-14 11:34:25.000000 mecord-cli-0.1.80/mecord/widget_template/icon.png.py
--rw-rw-rw-   0        0        0      719 2023-03-14 11:34:25.000000 mecord-cli-0.1.80/mecord/widget_template/index.html.py
--rw-rw-rw-   0        0        0    10084 2023-07-20 07:46:04.000000 mecord-cli-0.1.80/mecord/xy_pb.py
--rw-rw-rw-   0        0        0     2216 2023-04-10 11:57:12.000000 mecord-cli-0.1.80/mecord/xy_user.py
-drwxrwxrwx   0        0        0        0 2023-07-20 09:00:02.112977 mecord-cli-0.1.80/mecord_cli.egg-info/
--rw-rw-rw-   0        0        0     2364 2023-07-20 09:00:01.000000 mecord-cli-0.1.80/mecord_cli.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0     1009 2023-07-20 09:00:02.000000 mecord-cli-0.1.80/mecord_cli.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2023-07-20 09:00:01.000000 mecord-cli-0.1.80/mecord_cli.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       44 2023-07-20 09:00:01.000000 mecord-cli-0.1.80/mecord_cli.egg-info/entry_points.txt
--rw-rw-rw-   0        0        0       78 2023-07-20 09:00:01.000000 mecord-cli-0.1.80/mecord_cli.egg-info/requires.txt
--rw-rw-rw-   0        0        0       28 2023-07-20 09:00:01.000000 mecord-cli-0.1.80/mecord_cli.egg-info/top_level.txt
--rw-rw-rw-   0        0        0       42 2023-07-20 09:00:02.114978 mecord-cli-0.1.80/setup.cfg
--rw-rw-rw-   0        0        0     2523 2023-07-20 08:59:54.000000 mecord-cli-0.1.80/setup.py
...
### Comparing `mecord-cli-0.1.80/LICENSE` & `mecord-cli-0.1.9/LICENSE`

 * *Files identical despite different names*

### Comparing `mecord-cli-0.1.80/PKG-INFO` & `mecord-cli-0.1.9/PKG-INFO`
...
### Comparing `mecord-cli-0.1.80/README.md` & `mecord-cli-0.1.9/mecord_cli.egg-info/PKG-INFO`
...
### Comparing `mecord-cli-0.1.80/mecord/common_ext_pb2.py` & `mecord-cli-0.1.9/mecord/common_ext_pb2.py`
...
### Comparing `mecord-cli-0.1.80/mecord/mecord_service.py` & `mecord-cli-0.1.9/mecord/mecord_service.py`
...
-        #     print(f"======= touch!!!  ")
-        #     dddd = os.stat(f"/proc/{pid}")
-        #     print(f"======= touch!!!   {dddd}")
-        #     status = os.stat(f"/proc/{pid}").st_state
-        #     print(f"======= status {status}")
-        #     if status == "R" or status == "S" or status == 'D':
-        #         return True
-        #     else:
-        #         return False
-        # else:
...
-
-def stop_file():
-    return os.path.join(os.path.dirname(os.path.abspath(__file__)), "stop.now")
...
### Comparing `mecord-cli-0.1.80/mecord/rpcinput_pb2.py` & `mecord-cli-0.1.9/mecord/rpcinput_pb2.py`

 * *Files identical despite different names*

### Comparing `mecord-cli-0.1.80/mecord/script_template/main.py` & `mecord-cli-0.1.9/mecord/script_template/main.py`
...
### Comparing `mecord-cli-0.1.80/mecord/script_template/run.py` & `mecord-cli-0.1.9/mecord/script_template/run.py`
...
### Comparing `mecord-cli-0.1.80/mecord/uauth_common_pb2.py` & `mecord-cli-0.1.9/mecord/uauth_common_pb2.py`

 * *Files identical despite different names*

### Comparing `mecord-cli-0.1.80/mecord/uauth_ext_pb2.py` & `mecord-cli-0.1.9/mecord/uauth_ext_pb2.py`

 * *Files identical despite different names*

### Comparing `mecord-cli-0.1.80/mecord/user_status_ext_pb2.py` & `mecord-cli-0.1.9/mecord/user_status_ext_pb2.py`

 * *Files identical despite different names*

### Comparing `mecord-cli-0.1.80/mecord/widget_template/MekongJS.js.py` & `mecord-cli-0.1.9/mecord/widget_template/MekongJS.js.py`

 * *Files identical despite different names*

### Comparing `mecord-cli-0.1.80/mecord/widget_template/icon.png.py` & `mecord-cli-0.1.9/mecord/widget_template/icon.png.py`

 * *Files identical despite different names*

### Comparing `mecord-cli-0.1.80/mecord/widget_template/index.html.py` & `mecord-cli-0.1.9/mecord/widget_template/index.html.py`

 * *Files identical despite different names*

### Comparing `mecord-cli-0.1.80/mecord/xy_pb.py` & `mecord-cli-0.1.9/mecord/xy_pb.py`
...
### Comparing `mecord-cli-0.1.80/mecord/xy_user.py` & `mecord-cli-0.1.9/mecord/xy_user.py`
...
### Comparing `mecord-cli-0.1.80/mecord_cli.egg-info/SOURCES.txt` & `mecord-cli-0.1.9/mecord_cli.egg-info/SOURCES.txt`
