# Comparing `tmp/msaDocModels-0.0.84.tar.gz` & `tmp/msaDocModels-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "msaDocModels-0.0.84.tar", last modified: Thu Jul 20 11:09:41 2023, max compression
+gzip compressed data, was "msaDocModels-0.0.9.tar", last modified: Fri Nov 25 11:39:48 2022, max compression
```

## Comparing `msaDocModels-0.0.84.tar` & `msaDocModels-0.0.9.tar`

### file list

```diff
@@ -1,25 +1,24 @@
-drwxrwxr-x   0 vitaly    (1000) vitaly    (1000)        0 2023-07-20 11:09:41.222475 msaDocModels-0.0.84/
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     1099 2023-03-26 10:37:51.000000 msaDocModels-0.0.84/LICENCE
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     3679 2023-07-20 11:09:41.222475 msaDocModels-0.0.84/PKG-INFO
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     2198 2023-03-26 10:37:51.000000 msaDocModels-0.0.84/README.md
-drwxrwxr-x   0 vitaly    (1000) vitaly    (1000)        0 2023-07-20 11:09:41.222475 msaDocModels-0.0.84/msaDocModels/
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)      479 2023-07-20 10:32:33.000000 msaDocModels-0.0.84/msaDocModels/__init__.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)      562 2023-03-26 10:37:51.000000 msaDocModels-0.0.84/msaDocModels/health.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     3763 2023-03-26 10:37:51.000000 msaDocModels-0.0.84/msaDocModels/msg.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)      409 2023-04-13 04:38:32.000000 msaDocModels-0.0.84/msaDocModels/openapi.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     1111 2023-07-20 11:08:21.000000 msaDocModels-0.0.84/msaDocModels/pubsub.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     2413 2023-03-26 10:37:51.000000 msaDocModels-0.0.84/msaDocModels/scheduler.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)   155262 2023-07-20 10:48:32.000000 msaDocModels-0.0.84/msaDocModels/sdu.py
-drwxrwxr-x   0 vitaly    (1000) vitaly    (1000)        0 2023-07-20 11:09:41.222475 msaDocModels-0.0.84/msaDocModels/utils/
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)        0 2023-03-26 10:37:51.000000 msaDocModels-0.0.84/msaDocModels/utils/__init__.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     1826 2023-03-26 10:37:51.000000 msaDocModels-0.0.84/msaDocModels/utils/htmlutils.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)    22179 2023-03-26 10:37:51.000000 msaDocModels-0.0.84/msaDocModels/wdc.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     2103 2023-03-26 10:37:51.000000 msaDocModels-0.0.84/msaDocModels/wfl.py
-drwxrwxr-x   0 vitaly    (1000) vitaly    (1000)        0 2023-07-20 11:09:41.222475 msaDocModels-0.0.84/msaDocModels.egg-info/
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     3679 2023-07-20 11:09:41.000000 msaDocModels-0.0.84/msaDocModels.egg-info/PKG-INFO
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)      465 2023-07-20 11:09:41.000000 msaDocModels-0.0.84/msaDocModels.egg-info/SOURCES.txt
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)        1 2023-07-20 11:09:41.000000 msaDocModels-0.0.84/msaDocModels.egg-info/dependency_links.txt
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)       13 2023-07-20 11:09:41.000000 msaDocModels-0.0.84/msaDocModels.egg-info/top_level.txt
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)        1 2023-03-31 07:31:05.000000 msaDocModels-0.0.84/msaDocModels.egg-info/zip-safe
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)       38 2023-07-20 11:09:41.222475 msaDocModels-0.0.84/setup.cfg
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     2164 2023-03-26 10:37:51.000000 msaDocModels-0.0.84/setup.py
...
### Comparing `msaDocModels-0.0.84/LICENCE` & `msaDocModels-0.0.9/LICENCE`

 * *Files identical despite different names*

### Comparing `msaDocModels-0.0.84/PKG-INFO` & `msaDocModels-0.0.9/PKG-INFO`
...
```diff
@@ -1,10 +1,10 @@
-Metadata-Version: 2.1 Name: msaDocModels Version: 0.0.84 Summary: msaDocModels
...
### Comparing `msaDocModels-0.0.84/README.md` & `msaDocModels-0.0.9/README.md`
...
### Comparing `msaDocModels-0.0.84/msaDocModels/health.py` & `msaDocModels-0.0.9/msaDocModels/health.py`

 * *Files identical despite different names*

### Comparing `msaDocModels-0.0.84/msaDocModels/msg.py` & `msaDocModels-0.0.9/msaDocModels/msg.py`
...
### Comparing `msaDocModels-0.0.84/msaDocModels/scheduler.py` & `msaDocModels-0.0.9/msaDocModels/scheduler.py`
...
### Comparing `msaDocModels-0.0.84/msaDocModels/utils/htmlutils.py` & `msaDocModels-0.0.9/msaDocModels/utils/htmlutils.py`
...
### Comparing `msaDocModels-0.0.84/msaDocModels/wdc.py` & `msaDocModels-0.0.9/msaDocModels/wdc.py`
...
### Comparing `msaDocModels-0.0.84/msaDocModels/wfl.py` & `msaDocModels-0.0.9/msaDocModels/wfl.py`
...
### Comparing `msaDocModels-0.0.84/msaDocModels.egg-info/PKG-INFO` & `msaDocModels-0.0.9/msaDocModels.egg-info/PKG-INFO`
