# Comparing `tmp/biliarchiver-0.0.25.tar.gz` & `tmp/biliarchiver-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "biliarchiver-0.0.25.tar", max compression
+gzip compressed data, was "biliarchiver-0.0.9.tar", max compression
```

## Comparing `biliarchiver-0.0.25.tar` & `biliarchiver-0.0.9.tar`

### file list

```diff
@@ -1,19 +1,13 @@
--rw-r--r--   0        0        0      131 2023-07-07 09:38:51.631616 biliarchiver-0.0.25/README.md
--rw-r--r--   0        0        0     9436 2023-07-20 14:16:00.317178 biliarchiver-0.0.25/biliarchiver/_biliarchiver_upload_bvid.py
--rw-r--r--   0        0        0    10029 2023-07-20 14:48:24.122358 biliarchiver-0.0.25/biliarchiver/archive_bvid.py
--rw-r--r--   0        0        0     7427 2023-07-20 11:05:42.392259 biliarchiver-0.0.25/biliarchiver/cli_tools/bili_archive_bvids.py
--rw-r--r--   0        0        0     4133 2023-07-07 09:38:51.635616 biliarchiver-0.0.25/biliarchiver/cli_tools/bili_get_bvids.py
--rw-r--r--   0        0        0     2522 2023-07-20 14:46:47.257502 biliarchiver-0.0.25/biliarchiver/cli_tools/bili_upload.py
--rw-r--r--   0        0        0      413 2023-07-07 09:38:51.635616 biliarchiver-0.0.25/biliarchiver/cli_tools/biliarchiver.py
--rw-r--r--   0        0        0     2221 2023-07-20 09:58:51.188806 biliarchiver-0.0.25/biliarchiver/config.py
--rw-r--r--   0        0        0      375 2023-07-20 10:58:49.404609 biliarchiver-0.0.25/biliarchiver/exception.py
--rw-r--r--   0        0        0     1654 2023-07-18 05:39:18.960562 biliarchiver-0.0.25/biliarchiver/utils/black_list.py
--rw-r--r--   0        0        0     2724 2023-07-20 13:03:56.954965 biliarchiver-0.0.25/biliarchiver/utils/dirLock.py
--rw-r--r--   0        0        0      237 2023-07-07 09:38:51.635616 biliarchiver-0.0.25/biliarchiver/utils/ffmpeg.py
--rw-r--r--   0        0        0     1085 2023-07-18 04:24:04.652661 biliarchiver-0.0.25/biliarchiver/utils/http_patch.py
--rw-r--r--   0        0        0     1278 2023-07-07 09:38:51.635616 biliarchiver-0.0.25/biliarchiver/utils/string.py
--rw-r--r--   0        0        0     1635 2023-07-20 11:10:13.662657 biliarchiver-0.0.25/biliarchiver/utils/version_check.py
--rw-r--r--   0        0        0       32 2023-07-20 14:51:52.676201 biliarchiver-0.0.25/biliarchiver/version.py
--rw-r--r--   0        0        0      665 2023-07-20 14:52:01.724281 biliarchiver-0.0.25/pyproject.toml
--rw-r--r--   0        0        0     1307 1970-01-01 00:00:00.000000 biliarchiver-0.0.25/setup.py
--rw-r--r--   0        0        0      686 1970-01-01 00:00:00.000000 biliarchiver-0.0.25/PKG-INFO
...
### Comparing `biliarchiver-0.0.25/biliarchiver/_biliarchiver_upload_bvid.py` & `biliarchiver-0.0.9/biliarchiver/_biliarchiver_upload_bvid.py`
...
### Comparing `biliarchiver-0.0.25/biliarchiver/archive_bvid.py` & `biliarchiver-0.0.9/biliarchiver/archive_bvid.py`
...
### Comparing `biliarchiver-0.0.25/biliarchiver/cli_tools/bili_get_bvids.py` & `biliarchiver-0.0.9/biliarchiver/bili_get_bvids.py`

 * *Files identical despite different names*

### Comparing `biliarchiver-0.0.25/biliarchiver/config.py` & `biliarchiver-0.0.9/biliarchiver/config.py`
...
### Comparing `biliarchiver-0.0.25/biliarchiver/utils/dirLock.py` & `biliarchiver-0.0.9/biliarchiver/utils/dirLock.py`

 * *Files identical despite different names*

### Comparing `biliarchiver-0.0.25/biliarchiver/utils/string.py` & `biliarchiver-0.0.9/biliarchiver/utils/string.py`
