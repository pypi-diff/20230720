# Comparing `tmp/biliarchiver-0.0.21.tar.gz` & `tmp/biliarchiver-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "biliarchiver-0.0.21.tar", max compression
+gzip compressed data, was "biliarchiver-0.0.9.tar", max compression
```

## Comparing `biliarchiver-0.0.21.tar` & `biliarchiver-0.0.9.tar`

### file list

```diff
@@ -1,18 +1,13 @@
--rw-r--r--   0        0        0      131 2023-07-07 09:38:51.631616 biliarchiver-0.0.21/README.md
--rw-r--r--   0        0        0     9388 2023-07-20 10:15:05.825420 biliarchiver-0.0.21/biliarchiver/_biliarchiver_upload_bvid.py
--rw-r--r--   0        0        0     9224 2023-07-20 10:07:29.321385 biliarchiver-0.0.21/biliarchiver/archive_bvid.py
--rw-r--r--   0        0        0     7211 2023-07-18 06:32:20.920687 biliarchiver-0.0.21/biliarchiver/cli_tools/bili_archive_bvids.py
--rw-r--r--   0        0        0     4133 2023-07-07 09:38:51.635616 biliarchiver-0.0.21/biliarchiver/cli_tools/bili_get_bvids.py
--rw-r--r--   0        0        0     1845 2023-07-18 04:24:04.652661 biliarchiver-0.0.21/biliarchiver/cli_tools/bili_upload.py
--rw-r--r--   0        0        0      413 2023-07-07 09:38:51.635616 biliarchiver-0.0.21/biliarchiver/cli_tools/biliarchiver.py
--rw-r--r--   0        0        0     2221 2023-07-20 09:58:51.188806 biliarchiver-0.0.21/biliarchiver/config.py
--rw-r--r--   0        0        0      194 2023-07-07 09:38:51.635616 biliarchiver-0.0.21/biliarchiver/exception.py
--rw-r--r--   0        0        0     1654 2023-07-18 05:39:18.960562 biliarchiver-0.0.21/biliarchiver/utils/black_list.py
--rw-r--r--   0        0        0     2724 2023-07-07 09:38:51.635616 biliarchiver-0.0.21/biliarchiver/utils/dirLock.py
--rw-r--r--   0        0        0      237 2023-07-07 09:38:51.635616 biliarchiver-0.0.21/biliarchiver/utils/ffmpeg.py
--rw-r--r--   0        0        0     1085 2023-07-18 04:24:04.652661 biliarchiver-0.0.21/biliarchiver/utils/http_patch.py
--rw-r--r--   0        0        0     1278 2023-07-07 09:38:51.635616 biliarchiver-0.0.21/biliarchiver/utils/string.py
--rw-r--r--   0        0        0       32 2023-07-20 10:15:41.661737 biliarchiver-0.0.21/biliarchiver/version.py
--rw-r--r--   0        0        0      665 2023-07-20 10:15:30.489638 biliarchiver-0.0.21/pyproject.toml
--rw-r--r--   0        0        0     1307 1970-01-01 00:00:00.000000 biliarchiver-0.0.21/setup.py
--rw-r--r--   0        0        0      686 1970-01-01 00:00:00.000000 biliarchiver-0.0.21/PKG-INFO
...
### Comparing `biliarchiver-0.0.21/biliarchiver/_biliarchiver_upload_bvid.py` & `biliarchiver-0.0.9/biliarchiver/_biliarchiver_upload_bvid.py`
...
### Comparing `biliarchiver-0.0.21/biliarchiver/archive_bvid.py` & `biliarchiver-0.0.9/biliarchiver/archive_bvid.py`
...
### Comparing `biliarchiver-0.0.21/biliarchiver/cli_tools/bili_get_bvids.py` & `biliarchiver-0.0.9/biliarchiver/bili_get_bvids.py`

 * *Files identical despite different names*

### Comparing `biliarchiver-0.0.21/biliarchiver/cli_tools/bili_upload.py` & `biliarchiver-0.0.9/biliarchiver/bili_uploade.py`
...
### Comparing `biliarchiver-0.0.21/biliarchiver/config.py` & `biliarchiver-0.0.9/biliarchiver/config.py`
...
### Comparing `biliarchiver-0.0.21/biliarchiver/utils/dirLock.py` & `biliarchiver-0.0.9/biliarchiver/utils/dirLock.py`

 * *Files identical despite different names*

### Comparing `biliarchiver-0.0.21/biliarchiver/utils/string.py` & `biliarchiver-0.0.9/biliarchiver/utils/string.py`
