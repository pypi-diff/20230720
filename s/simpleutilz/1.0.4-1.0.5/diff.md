# Comparing `tmp/simpleutilz-1.0.4.tar.gz` & `tmp/simpleutilz-1.0.5.tar.gz`
...
## Comparing `simpleutilz-1.0.4.tar` & `simpleutilz-1.0.5.tar`
...
### Comparing `simpleutilz-1.0.4/LICENSE` & `simpleutilz-1.0.5/LICENSE`

 * *Files identical despite different names*

### Comparing `simpleutilz-1.0.4/PKG-INFO` & `simpleutilz-1.0.5/PKG-INFO`
...
### Comparing `simpleutilz-1.0.4/setup.py` & `simpleutilz-1.0.5/setup.py`
...
### Comparing `simpleutilz-1.0.4/simpleutilz.egg-info/PKG-INFO` & `simpleutilz-1.0.5/simpleutilz.egg-info/PKG-INFO`
