# Comparing `tmp/database-without-orm-local-0.0.12.tar.gz` & `tmp/database-without-orm-local-0.0.13.tar.gz`
...
## Comparing `database-without-orm-local-0.0.12.tar` & `database-without-orm-local-0.0.13.tar`
...
### Comparing `database-without-orm-local-0.0.12/setup.py` & `database-without-orm-local-0.0.13/setup.py`
