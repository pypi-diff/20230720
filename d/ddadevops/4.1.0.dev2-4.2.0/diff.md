# Comparing `tmp/ddadevops-4.1.0.dev2.tar.gz` & `tmp/ddadevops-4.2.0.tar.gz`
...
## Comparing `ddadevops-4.1.0.dev2.tar` & `ddadevops-4.2.0.tar`
...
### Comparing `ddadevops-4.1.0.dev2/PKG-INFO` & `ddadevops-4.2.0/PKG-INFO`
...
### Comparing `ddadevops-4.1.0.dev2/ddadevops/LICENSE` & `ddadevops-4.2.0/ddadevops/LICENSE`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/__init__.py` & `ddadevops-4.2.0/ddadevops/__init__.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/application/image_build_service.py` & `ddadevops-4.2.0/ddadevops/application/image_build_service.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/application/release_mixin_services.py` & `ddadevops-4.2.0/ddadevops/application/release_mixin_services.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/application/terraform_service.py` & `ddadevops-4.2.0/ddadevops/application/terraform_service.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/aws_mfa_mixin.py` & `ddadevops-4.2.0/ddadevops/aws_mfa_mixin.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/c4k_build.py` & `ddadevops-4.2.0/ddadevops/c4k_build.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/devops_build.py` & `ddadevops-4.2.0/ddadevops/devops_build.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/devops_image_build.py` & `ddadevops-4.2.0/ddadevops/devops_image_build.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/devops_terraform_build.py` & `ddadevops-4.2.0/ddadevops/devops_terraform_build.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/domain/__init__.py` & `ddadevops-4.2.0/ddadevops/domain/__init__.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/domain/build_file.py` & `ddadevops-4.2.0/ddadevops/domain/build_file.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/domain/c4k.py` & `ddadevops-4.2.0/ddadevops/domain/c4k.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/domain/common.py` & `ddadevops-4.2.0/ddadevops/domain/common.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/domain/credentials.py` & `ddadevops-4.2.0/ddadevops/domain/credentials.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/domain/devops_factory.py` & `ddadevops-4.2.0/ddadevops/domain/devops_factory.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/domain/image.py` & `ddadevops-4.2.0/ddadevops/domain/image.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/domain/init_service.py` & `ddadevops-4.2.0/ddadevops/domain/init_service.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/domain/provider_aws.py` & `ddadevops-4.2.0/ddadevops/domain/provider_aws.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/domain/provider_digitalocean.py` & `ddadevops-4.2.0/ddadevops/domain/provider_digitalocean.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/domain/provider_hetzner.py` & `ddadevops-4.2.0/ddadevops/domain/provider_hetzner.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/domain/provs_k3s.py` & `ddadevops-4.2.0/ddadevops/domain/provs_k3s.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/domain/release.py` & `ddadevops-4.2.0/ddadevops/domain/release.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/domain/terraform.py` & `ddadevops-4.2.0/ddadevops/domain/terraform.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/domain/version.py` & `ddadevops-4.2.0/ddadevops/domain/version.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/infrastructure/infrastructure.py` & `ddadevops-4.2.0/ddadevops/infrastructure/infrastructure.py`
...
### Comparing `ddadevops-4.1.0.dev2/ddadevops/infrastructure/repository.py` & `ddadevops-4.2.0/ddadevops/infrastructure/repository.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/provs_k3s_build.py` & `ddadevops-4.2.0/ddadevops/provs_k3s_build.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/release_mixin.py` & `ddadevops-4.2.0/ddadevops/release_mixin.py`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops/src/main/resources/docker/image/resources/install_functions.sh` & `ddadevops-4.2.0/ddadevops/src/main/resources/docker/image/resources/install_functions.sh`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/ddadevops.egg-info/PKG-INFO` & `ddadevops-4.2.0/ddadevops.egg-info/PKG-INFO`
...
### Comparing `ddadevops-4.1.0.dev2/ddadevops.egg-info/SOURCES.txt` & `ddadevops-4.2.0/ddadevops.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `ddadevops-4.1.0.dev2/setup.py` & `ddadevops-4.2.0/setup.py`
