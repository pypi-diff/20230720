# Comparing `tmp/adafri-0.0.44.tar.gz` & `tmp/adafri-0.0.45.tar.gz`
...
### Comparing `adafri-0.0.44/adafri/v1/user/models/user.py` & `adafri-0.0.45/adafri/v1/user/models/user.py`
