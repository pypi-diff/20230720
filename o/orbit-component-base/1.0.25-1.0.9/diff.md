# Comparing `tmp/orbit_component_base-1.0.25.tar.gz` & `tmp/orbit_component_base-1.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "orbit_component_base-1.0.25.tar", max compression
+gzip compressed data, was "orbit_component_base-1.0.9.tar", max compression
```

## Comparing `orbit_component_base-1.0.25.tar` & `orbit_component_base-1.0.9.tar`

### file list

```diff
@@ -1,35 +1,28 @@
--rw-r--r--   0        0        0     1099 2023-05-30 15:19:20.188832 orbit_component_base-1.0.25/LICENSE.md
--rw-r--r--   0        0        0      307 2023-05-30 15:19:20.188832 orbit_component_base-1.0.25/README.md
--rw-r--r--   0        0        0      248 2023-05-30 15:19:20.188832 orbit_component_base-1.0.25/orbit_component_base/__init__.py
--rw-r--r--   0        0        0      206 2023-05-30 15:19:46.404293 orbit_component_base-1.0.25/orbit_component_base/cli/cli_base.py
--rw-r--r--   0        0        0     4646 2023-06-30 16:41:46.932914 orbit_component_base-1.0.25/orbit_component_base/cli/group_permissions.py
--rw-r--r--   0        0        0     3163 2023-06-30 17:15:55.107897 orbit_component_base-1.0.25/orbit_component_base/cli/permissions.py
--rw-r--r--   0        0        0     1691 2023-06-10 13:38:38.437638 orbit_component_base-1.0.25/orbit_component_base/cli/sessions.py
--rw-r--r--   0        0        0     2036 2023-07-06 10:49:46.366571 orbit_component_base-1.0.25/orbit_component_base/cli/users.py
--rw-r--r--   0        0        0     5263 2023-07-04 13:24:35.768682 orbit_component_base-1.0.25/orbit_component_base/plugin.py
--rw-r--r--   0        0        0     1963 2023-07-06 14:47:23.251031 orbit_component_base-1.0.25/orbit_component_base/schema/OrbitGroupPermissions.py
--rw-r--r--   0        0        0     1613 2023-06-23 14:35:03.647017 orbit_component_base-1.0.25/orbit_component_base/schema/OrbitPermissions.py
--rw-r--r--   0        0        0     1342 2023-06-22 12:00:55.061359 orbit_component_base-1.0.25/orbit_component_base/schema/OrbitSessions.py
--rw-r--r--   0        0        0     1413 2023-07-04 16:43:44.101536 orbit_component_base-1.0.25/orbit_component_base/schema/OrbitUsers.py
--rwxr-xr-x   0        0        0     4821 2023-07-10 09:55:48.826063 orbit_component_base-1.0.25/orbit_component_base/src/orbit_app.py
--rw-r--r--   0        0        0     6555 2023-06-22 11:38:34.572765 orbit_component_base-1.0.25/orbit_component_base/src/orbit_auth.py
--rw-r--r--   0        0        0     7350 2023-06-30 15:29:25.195966 orbit_component_base-1.0.25/orbit_component_base/src/orbit_config.py
--rw-r--r--   0        0        0     1264 2023-07-06 11:29:07.067710 orbit_component_base-1.0.25/orbit_component_base/src/orbit_database.py
--rw-r--r--   0        0        0     4256 2023-07-07 15:38:44.572226 orbit_component_base-1.0.25/orbit_component_base/src/orbit_decorators.py
--rw-r--r--   0        0        0      290 2023-05-30 15:19:20.188832 orbit_component_base-1.0.25/orbit_component_base/src/orbit_logger.py
--rw-r--r--   0        0        0      834 2023-05-30 16:30:11.592032 orbit_component_base-1.0.25/orbit_component_base/src/orbit_make_ssl.py
--rw-r--r--   0        0        0     8909 2023-07-06 11:50:45.939350 orbit_component_base-1.0.25/orbit_component_base/src/orbit_nql.py
--rw-r--r--   0        0        0     3534 2023-05-30 15:19:20.188832 orbit_component_base-1.0.25/orbit_component_base/src/orbit_nql_buffer.py
--rw-r--r--   0        0        0      895 2023-06-23 14:40:36.048032 orbit_component_base-1.0.25/orbit_component_base/src/orbit_nql_emitter.py
--rw-r--r--   0        0        0     4442 2023-05-30 15:19:20.188832 orbit_component_base-1.0.25/orbit_component_base/src/orbit_nql_session.py
--rw-r--r--   0        0        0     6654 2023-07-13 11:45:01.229352 orbit_component_base-1.0.25/orbit_component_base/src/orbit_orm.py
--rw-r--r--   0        0        0     2836 2023-07-06 10:31:16.650083 orbit_component_base-1.0.25/orbit_component_base/src/orbit_plugin.py
--rw-r--r--   0        0        0     2148 2023-06-02 16:17:04.740333 orbit_component_base-1.0.25/orbit_component_base/src/orbit_plugins.py
--rw-r--r--   0        0        0     2323 2023-06-05 13:10:08.334760 orbit_component_base-1.0.25/orbit_component_base/src/orbit_router.py
--rw-r--r--   0        0        0      629 2023-05-30 15:19:20.192832 orbit_component_base-1.0.25/orbit_component_base/src/orbit_shared.py
--rw-r--r--   0        0        0     6489 2023-06-23 12:53:38.130760 orbit_component_base-1.0.25/orbit_component_base/src/orbit_shells.py
--rw-r--r--   0        0        0       21 2023-05-30 15:19:20.192832 orbit_component_base-1.0.25/orbit_component_base/src/orbit_version.py
--rw-r--r--   0        0        0       76 2023-05-30 15:19:20.192832 orbit_component_base-1.0.25/orbit_component_base/tests/test_main.py
--rw-r--r--   0        0        0       23 2023-07-20 17:07:25.117687 orbit_component_base-1.0.25/orbit_component_base/version.py
--rw-r--r--   0        0        0     1411 2023-07-20 17:07:25.117687 orbit_component_base-1.0.25/pyproject.toml
--rw-r--r--   0        0        0     1614 1970-01-01 00:00:00.000000 orbit_component_base-1.0.25/PKG-INFO
...
### Comparing `orbit_component_base-1.0.25/LICENSE.md` & `orbit_component_base-1.0.9/LICENSE.md`

 * *Files identical despite different names*

### Comparing `orbit_component_base-1.0.25/orbit_component_base/schema/OrbitSessions.py` & `orbit_component_base-1.0.9/orbit_component_base/schema/OrbitSessions.py`
...
### Comparing `orbit_component_base-1.0.25/orbit_component_base/src/orbit_app.py` & `orbit_component_base-1.0.9/orbit_component_base/src/orbit_app.py`
...
### Comparing `orbit_component_base-1.0.25/orbit_component_base/src/orbit_auth.py` & `orbit_component_base-1.0.9/orbit_component_base/src/orbit_auth.py`
...
### Comparing `orbit_component_base-1.0.25/orbit_component_base/src/orbit_config.py` & `orbit_component_base-1.0.9/orbit_component_base/src/orbit_config.py`
...
### Comparing `orbit_component_base-1.0.25/orbit_component_base/src/orbit_database.py` & `orbit_component_base-1.0.9/orbit_component_base/src/orbit_database.py`
...
### Comparing `orbit_component_base-1.0.25/orbit_component_base/src/orbit_decorators.py` & `orbit_component_base-1.0.9/orbit_component_base/src/orbit_decorators.py`
...
### Comparing `orbit_component_base-1.0.25/orbit_component_base/src/orbit_make_ssl.py` & `orbit_component_base-1.0.9/orbit_component_base/src/orbit_make_ssl.py`

 * *Files identical despite different names*

### Comparing `orbit_component_base-1.0.25/orbit_component_base/src/orbit_nql.py` & `orbit_component_base-1.0.9/orbit_component_base/src/orbit_nql.py`
...
### Comparing `orbit_component_base-1.0.25/orbit_component_base/src/orbit_nql_buffer.py` & `orbit_component_base-1.0.9/orbit_component_base/src/orbit_nql_buffer.py`

 * *Files identical despite different names*

### Comparing `orbit_component_base-1.0.25/orbit_component_base/src/orbit_nql_emitter.py` & `orbit_component_base-1.0.9/orbit_component_base/src/orbit_nql_emitter.py`

 * *Files identical despite different names*

### Comparing `orbit_component_base-1.0.25/orbit_component_base/src/orbit_nql_session.py` & `orbit_component_base-1.0.9/orbit_component_base/src/orbit_nql_session.py`

 * *Files identical despite different names*

### Comparing `orbit_component_base-1.0.25/orbit_component_base/src/orbit_orm.py` & `orbit_component_base-1.0.9/orbit_component_base/src/orbit_orm.py`
...
### Comparing `orbit_component_base-1.0.25/orbit_component_base/src/orbit_plugin.py` & `orbit_component_base-1.0.9/orbit_component_base/src/orbit_plugin.py`
...
### Comparing `orbit_component_base-1.0.25/orbit_component_base/src/orbit_plugins.py` & `orbit_component_base-1.0.9/orbit_component_base/src/orbit_plugins.py`

 * *Files identical despite different names*

### Comparing `orbit_component_base-1.0.25/orbit_component_base/src/orbit_router.py` & `orbit_component_base-1.0.9/orbit_component_base/src/orbit_router.py`

 * *Files identical despite different names*

### Comparing `orbit_component_base-1.0.25/orbit_component_base/src/orbit_shared.py` & `orbit_component_base-1.0.9/orbit_component_base/src/orbit_shared.py`

 * *Files identical despite different names*

### Comparing `orbit_component_base-1.0.25/pyproject.toml` & `orbit_component_base-1.0.9/pyproject.toml`
...
### Comparing `orbit_component_base-1.0.25/PKG-INFO` & `orbit_component_base-1.0.9/PKG-INFO`
