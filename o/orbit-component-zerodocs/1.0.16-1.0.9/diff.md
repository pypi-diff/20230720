# Comparing `tmp/orbit_component_zerodocs-1.0.16.tar.gz` & `tmp/orbit_component_zerodocs-1.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "orbit_component_zerodocs-1.0.16.tar", max compression
+gzip compressed data, was "orbit_component_zerodocs-1.0.9.tar", max compression
```

## Comparing `orbit_component_zerodocs-1.0.16.tar` & `orbit_component_zerodocs-1.0.9.tar`

### file list

```diff
@@ -1,12 +1,12 @@
--rw-r--r--   0        0        0     1099 2023-05-30 15:19:37.980465 orbit_component_zerodocs-1.0.16/LICENSE.md
--rw-r--r--   0        0        0      220 2023-05-30 20:41:27.418669 orbit_component_zerodocs-1.0.16/README.md
--rw-r--r--   0        0        0       97 2023-07-10 09:48:58.739070 orbit_component_zerodocs-1.0.16/orbit_component_zerodocs/__init__.py
--rwxr-xr-x   0        0        0    22584 2023-07-13 12:44:58.370278 orbit_component_zerodocs-1.0.16/orbit_component_zerodocs/doc_python.py
--rw-r--r--   0        0        0     3758 2023-07-20 11:32:26.488027 orbit_component_zerodocs-1.0.16/orbit_component_zerodocs/plugin.py
--rw-r--r--   0        0        0     2948 2023-07-10 13:56:26.227823 orbit_component_zerodocs-1.0.16/orbit_component_zerodocs/schema/APIs.py
--rw-r--r--   0        0        0    14038 2023-07-20 17:01:20.569259 orbit_component_zerodocs-1.0.16/orbit_component_zerodocs/schema/Cache.py
--rw-r--r--   0        0        0     1868 2023-07-13 12:27:27.754789 orbit_component_zerodocs-1.0.16/orbit_component_zerodocs/schema/Project.py
--rw-r--r--   0        0        0      270 2023-07-13 17:20:37.712326 orbit_component_zerodocs-1.0.16/orbit_component_zerodocs/schema/Versions.py
--rw-r--r--   0        0        0        0 2023-07-20 17:06:25.138974 orbit_component_zerodocs-1.0.16/orbit_component_zerodocs/version.py
--rw-r--r--   0        0        0     1401 2023-07-20 17:06:25.138974 orbit_component_zerodocs-1.0.16/pyproject.toml
--rw-r--r--   0        0        0     1498 1970-01-01 00:00:00.000000 orbit_component_zerodocs-1.0.16/PKG-INFO
...
### Comparing `orbit_component_zerodocs-1.0.16/LICENSE.md` & `orbit_component_zerodocs-1.0.9/LICENSE.md`

 * *Files identical despite different names*

### Comparing `orbit_component_zerodocs-1.0.16/orbit_component_zerodocs/doc_python.py` & `orbit_component_zerodocs-1.0.9/orbit_component_zerodocs/doc_python.py`
...
### Comparing `orbit_component_zerodocs-1.0.16/orbit_component_zerodocs/schema/APIs.py` & `orbit_component_zerodocs-1.0.9/orbit_component_zerodocs/schema/APIs.py`
...
### Comparing `orbit_component_zerodocs-1.0.16/orbit_component_zerodocs/schema/Cache.py` & `orbit_component_zerodocs-1.0.9/orbit_component_zerodocs/schema/Cache.py`
...
-            log.error(f"Get, ref={self._branch}")
     ...
     def thread_head (self):
         try:
             ...
             if not project:
                 raise Exception(f'unknown project id: {self._project_id}')
-            log.error(f"Head, path={self._path}, ref={self._branch}")
...
-        # log.error(f"Open: {doc._cache_path('text')}")
...
### Comparing `orbit_component_zerodocs-1.0.16/orbit_component_zerodocs/schema/Project.py` & `orbit_component_zerodocs-1.0.9/orbit_component_zerodocs/schema/Project.py`
...
### Comparing `orbit_component_zerodocs-1.0.16/pyproject.toml` & `orbit_component_zerodocs-1.0.9/pyproject.toml`
...
### Comparing `orbit_component_zerodocs-1.0.16/PKG-INFO` & `orbit_component_zerodocs-1.0.9/PKG-INFO`
